...
_TEST_DEV_DATA = {'connected': True, 'nodes': [{'addr': 1, 'name': 'My Heater', 'type': 'htr'}]}
_TEST_UPDATE_1 = {'path': '/htr/1/status', 'body': {'mode': 'auto', 'stemp': '15.5', 'mtemp': '10.7', 'units': 'C'}}
_TEST_UPDATE_2 = {'path': '/htr/1/status', 'body': {'mode': 'auto', 'stemp': '15.5', 'mtemp': '11.1', 'units': 'C'}}
...
class MockServer(object):
    ...
    def __init__(self, port, connect_event=None, ping_event=None):
        ...
        self._namespace = self.TestAPIV2Namespace('/api/v2/socket_io', connect_event, ping_event)
